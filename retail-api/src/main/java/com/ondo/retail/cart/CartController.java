...
public class CartController {
    ...
    public ApiResponse<Void> changeQty(@PathVariable Long cartItemId,
    ...
    public ApiResponse<Void> remove(@PathVariable Long cartItemId, Authentication authentication) {
